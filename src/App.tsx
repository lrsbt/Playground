...
export const PLAYGROUNDS = [
  ...
  lazy(() => import("./playgrounds/22")),
  lazy(() => import("./playgrounds/23")),
  lazy(() => import("./playgrounds/24")),
  lazy(() => import("./playgrounds/25")),
  lazy(() => import("./playgrounds/26")),
  lazy(() => import("./playgrounds/27")),
  lazy(() => import("./playgrounds/28")),
  lazy(() => import("./playgrounds/29")),
  lazy(() => import("./playgrounds/30")),
  lazy(() => import("./playgrounds/31")),
  lazy(() => import("./playgrounds/32")),
  lazy(() => import("./playgrounds/33")),
  lazy(() => import("./playgrounds/34")),
];
